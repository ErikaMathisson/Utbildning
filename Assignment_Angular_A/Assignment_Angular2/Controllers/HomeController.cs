using Assignment_Angular_A.Models;
using System;
...
namespace Assignment_Angular_A.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public JsonResult AddPerson([Bind(Include = "Name, Email, PhoneNumber, Country")]Person p)
        {
        ...
        public JsonResult EditPerson([Bind(Include = "Name, Email, PhoneNumber, Country")]Person p)
        {
            if (ModelState.IsValid)
            {
